        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-6">
              Ariyak was born from a simple observation: Cambodian SMEs need digital tools that actually work, built by people who truly care about local market.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              Founded by a Senior Web & Mobile Development Trainer with over 10 years of experience in full-stack engineering and agile delivery, Ariyak operates on a unique model. We aren't just a software house; we are a specialized team where veteran expertise meets country's most promising developers.
            </p>
